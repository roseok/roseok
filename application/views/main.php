                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                ...
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a href="#special">NIEUWS</a></li>
                                    <li><a href="#features">PROJECTEN</a></li>
                                    <li><a href="#special">MAKERS</a></li>
...
<section id="banner" class="banner">
    <img class="mySlides" src="images/bannerbg.jpg" style="width:100%">
    <img class="mySlides" src="images/bannerbg1.jpg" style="width:100%">
    <img class="mySlides" src="images/bannerbg3.jpg" style="width:100%">
    <!-- <div class="container">
        <div class="row">
            ...
            <div class="features_content text-center">
                <div class="col-md-4">
                    <div class="sinle_features wow slideInUp" data-wow-duration="1s">
                        ...
                        <h5>WAT WE DOEN</h5>
                        <p>Rose stories is een  plek waar verhalen uit verschillende culturen een <a href="<?= base_url('over');?>">...read more</a></p>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="sinle_features wow slideInUp" data-wow-duration="1.5s">
                        ...
                        <p>We geloven in de kracht van het verhaal, voor het teweegbrengen van positieve verandering ter bevordering van gelijkheid en diversiteit in de samenleving.<a href="<?= base_url('over');?>">...read more</a></p>
                ...
                <div class="col-md-4">
                    <div class="sinle_features wow slideInUp" data-wow-duration="2s">
                        ...
                        <p>Op onze eigen manier: pragmatisch, effectief en liefdevol. Maar ook met gezond verstand, hollandse nuchterheid en vereende krachten.<a href="<?= base_url('over');?>">...Read more</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="main_special text-center wow slideInUp" data-wow-duration="3s">
                ...
                <!-- <div class="col-md-2 col-sm-3 col-xs-6 single_special">
                    <div class="single_special_img">
                        <img style="height:195px; " src="images/p6.jpg" alt="" />
                        <div class="single_special_overlay text-center">
                            <h3>JAMILA ZEMOURI</h3>
                            <a href="http://www.rosestories.nl/over/?.wpb_wrapper" target="frame1" style="text-decoration:none">
                            <div class="overlay_separetor"></div>
                            <p>Uitgeverij</p>
                            </a>
            ...
            <div class="main_abouts">
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="single_abouts wow slideInLeft" data-wow-duration="2s">
                        ...
                        <div class="signature_img text-right">
                            ...
                            <a href="http://www.rosestories.nl/nieuws/" target="_blank">Meer Nieuwes</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <div class="single_abouts wow slideInRight" data-wow-duration="2s">
                        ...
                        <img src="images/Chris van Houts.jpg" alt="" />
                    </div>
                </div>
            </div>
        </div>
